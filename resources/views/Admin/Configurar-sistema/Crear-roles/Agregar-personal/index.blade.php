...
<head>
    ...
    <title>Agregar Personal de Seguridad</title>
...
<body class="bg-blue-200 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg">
        <div class="flex justify-between items-center mb-4">
            ...
            <h1 class="text-xl font-bold text-blue-700 pr-16">Agregar personal de seguridad</h1>
        </div>
        <p class="text-gray-600 text-sm mb-6">Llene el formulario con los datos del personal de seguridad y luego presione siguiente</p>
        ...
        <form action="{{ route('Agregar.personal.pedir-huella')}}" method="post" id="securityForm">
            @csrf
            <div class="mb-4">
