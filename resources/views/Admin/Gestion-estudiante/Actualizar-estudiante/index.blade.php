...
<body class="min-h-screen bg-blue-200 flex justify-center items-center">
    ...
    <div id="modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg mx-4 transform transition-all animate-fade-in">
            ...
            <div class="flex justify-center space-x-3">
                <button 
                class="bg-yellow-500 text-white px-5 py-3 rounded-md hover:bg-yellow-600 transition transform hover:scale-105 flex items-center whitespace-nowrap h-11 duration-300"
                onclick="actualizarHuella()">
                <i class="fas fa-fingerprint mr-2"></i>Actualizar Huella
            </button>
            
            <button 
                class="bg-green-500 text-white px-5 py-3 rounded-md hover:bg-green-600 transition transform hover:scale-105 flex items-center whitespace-nowrap h-11 duration-300"
                onclick="irAActualizarDatos()">
                <i class="fas fa-edit mr-2"></i>Actualizar Datos
            </button>
            
            <button 
                class="bg-red-500 text-white px-5 py-3 rounded-md hover:bg-red-600 transition transform hover:scale-105 flex items-center whitespace-nowrap h-11 duration-300"
                onclick="cerrarModal()">
