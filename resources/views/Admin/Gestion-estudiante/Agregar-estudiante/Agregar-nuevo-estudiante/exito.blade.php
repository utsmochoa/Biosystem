...
<body class="bg-blue-200">
  <div class="max-w-4xl mx-auto mt-8 bg-white shadow-md rounded-lg">
    ...
    <div class="bg-white text-blue-700 px-6 py-4 rounded-t-lg flex items-center">
        ...
        <h1 class="text-xl font-bold text-blue-800 text-center flex-grow pr-16">Añadir estudiante nuevo</h1>
    </div>

    <!-- Contenido -->
    <div class="p-8 text-center">
      <p class="text-lg font-medium text-blue-900 mb-6">¡Estudiante añadido con éxito!</p>
